...
class TestSessionWorkflowsE2E(BaseE2ETest):
    ...
    def test_complete_session_creation_and_upload_workflow(self, authenticated_user, db_session):
        ...
        print(f"✅ Session creation and upload workflow completed for session {session_id}")

    def test_session_status_tracking_workflow(self, authenticated_user_with_session, db_session):
        ...
        assert "estimated_completion" in updated_status or updated_status["estimated_completion"] is None

        print(f"✅ Session status tracking workflow completed for session {session_id}")

    def test_session_listing_and_filtering_workflow(self, authenticated_user, db_session):
        ...
        print(f"✅ Session listing and filtering workflow completed")

    def test_session_detail_retrieval_workflow(self, authenticated_user_with_session, db_session):
        ...
        print(f"✅ Session detail retrieval workflow completed for session {session_id}")

    def test_transcript_upload_workflow(self, authenticated_user_with_session, db_session):
...
"""
        ...
        print(f"✅ Transcript upload workflow completed for sessions {session_id} and {new_session_id}")

    def test_transcript_export_workflow(self, authenticated_user_with_completed_session, db_session):
        ...
        for format_type in formats:
            ...
            if export_response.status_code == 200:
                ...
                print(f"⚠️ Export format {format_type} returned {export_response.status_code}")
    ...
    def test_session_error_handling_workflow(self, authenticated_user, db_session):
        ...
        print(f"✅ Session error handling workflow completed")
    ...
    def test_concurrent_session_operations(self, authenticated_user, db_session):
        ...
        print(f"✅ Concurrent session operations test completed")
    ...
    def test_session_workflow_with_speaker_roles(self, authenticated_user_with_completed_session, db_session):
        ...
        print(f"✅ Session workflow with speaker roles completed for session {session_id}")