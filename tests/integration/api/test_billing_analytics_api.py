...
from coaching_assistant.models.user import User, UserRole, UserPlan
...
class TestBillingAnalyticsAPI:
    ...
    def mock_auth_admin(self, admin_user):
        ...
        with patch('coaching_assistant.api.dependencies.require_admin') as mock_require_admin:
    ...
    def test_get_billing_analytics_overview_success(
        ...
        with patch('coaching_assistant.services.billing_analytics_service.BillingAnalyticsService') as MockService:
    ...
    def test_get_user_analytics_detail(self, client, mock_auth_admin, mock_db):
        ...
        with patch('coaching_assistant.services.billing_analytics_service.BillingAnalyticsService') as MockService:
            ...
            response = client.get(f"/api/v1/admin/billing-analytics/users/{user_id}/analytics")
    ...
    def test_get_user_analytics_detail_user_not_found(self, client, mock_auth_admin, mock_db):
    ...
    def test_get_plan_performance(self, client, mock_auth_admin, mock_db):
        ...
        with patch('coaching_assistant.services.billing_analytics_service.BillingAnalyticsService') as MockService:
            ...
            mock_service.get_plan_performance_analysis.return_value = {
                ...
                "upgrade_patterns": {"free_to_pro": 10, "pro_to_enterprise": 3},
    ...
    def test_refresh_billing_analytics_single_user(self, client, mock_auth_admin, mock_db):
    ...
    def test_refresh_billing_analytics_all_users(self, client, mock_auth_admin, mock_db):
    ...
    def test_get_health_score_distribution(self, client, mock_auth_admin, mock_db):
        ...
        with patch('coaching_assistant.services.billing_analytics_service.BillingAnalyticsService') as MockService:
            ...
            response = client.get("/api/v1/admin/billing-analytics/health-score-distribution")
