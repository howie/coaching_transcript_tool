...
class TestPlansCurrentTransactionFix:
    ...
    def authenticated_headers(self, test_user):
        ...
        # Mock JWT token for testing - in real implementation this would be a
        # valid JWT
    ...
    def test_plans_current_no_subscription_transaction_handling(
        ...
        try:
            ...
            response = client.get(
                "/api/v1/plans/current", headers=authenticated_headers
            )
    ...
    def test_plans_current_database_error_handling(
        ...
        try:
            ...
            # Assert - should either succeed or fail gracefully (no 500 from
            # transaction issues)
            assert response.status_code in [200, 404, 500]

            # If it's a 500, it should be from application logic, not
