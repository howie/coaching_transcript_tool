...
class TestUsageHistory:
    ...
    def test_usage_history_properties(self, db_session):
        ...
        assert usage_history.avg_session_duration_minutes == 30.0  # 120 minutes / 4 transcriptions
        
        # Test success_rate
        assert usage_history.success_rate == 80.0  # 4 successful / 5 total * 100
        
        # Test cost_per_minute
        assert usage_history.cost_per_minute == pytest.approx(0.0833, rel=1e-3)  # $10 / 120 minutes
