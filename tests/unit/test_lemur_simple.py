...
async def test_simple_lemur():
    ...
    try:
        ...
        has_punctuation = any('，' in seg.text or '。' in seg.text or '？' in seg.text for seg in result.segments)
        no_extra_spaces = all('我 是' not in seg.text and '你 好' not in seg.text for seg in result.segments)
        ...
        has_traditional = any('學' in seg.text or '們' in seg.text or '會' in seg.text for seg in result.segments)
        no_simplified = all('学' not in seg.text and '们' not in seg.text for seg in result.segments)
        ...
        success = has_punctuation and no_extra_spaces and has_speaker_mapping and (has_traditional and no_simplified)
