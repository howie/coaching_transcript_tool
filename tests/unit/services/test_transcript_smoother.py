        ...
        utterances = [
            Utterance(
                ...
                words=[
                    ...
                    ),  # Terminal punctuation to avoid short head rule
                ],
            ),
            Utterance(
                speaker="B",
                ...
                words=[
                    WordTimestamp(
                        text="嗯", start=2100, end=2400
                    ),  # Filler word, short duration
                ],
            ),
        ]
    ...
    def test_filler_word_backfill_without_terminal_punct(self):
        ...
        utterances = [
            ...
            Utterance(
                ...
                words=[
                    WordTimestamp(
                        text="嗯", start=2500, end=2800
                    ),  # Filler word, 0.3 sec duration
                ],
            ),
        ]
...
class TestErrorHandling:
    ...
    def test_unsupported_language_error(self):
        ...
        with pytest.raises(UnsupportedLanguageError):
            LanguageProcessorFactory.create_processor(
                SupportedLanguage.AUTO
            )  # AUTO is not a processor
...
def create_test_utterance(
    speaker: str, words_data: List[Dict[str, Any]], start_offset: int = 0
) -> Utterance:
