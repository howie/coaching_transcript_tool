...
from coaching_assistant.services.billing_analytics_service import BillingAnalyticsService
...
class TestBillingAnalyticsService:
    ...
    def service(self, mock_db):
        ...
        with patch('coaching_assistant.services.billing_analytics_service.UsageAnalyticsService') as mock_usage_service:
    ...
    def test_get_admin_overview(self, service, mock_db, sample_billing_data):
        ...
        assert revenue_metrics["gross_margin"] == 74.99  # 99.99 - 25.00
    ...
    def test_get_user_analytics_detail(self, service, mock_db):
        ...
        mock_db.query.side_effect = [mock_user_query, mock_billing_query]
        
        # Mock usage analytics service
        service.usage_analytics_service.predict_usage.return_value = {"predicted_sessions": 30}
        service.usage_analytics_service.generate_insights.return_value = [{"type": "test"}]
    ...
    def test_export_analytics_data_csv(self, service, mock_db, sample_billing_data):
        ...
        export_result = service.export_analytics_data("csv", period_start, period_end, False)
    ...
    def test_export_analytics_data_json(self, service, mock_db, sample_billing_data):
        ...
        export_result = service.export_analytics_data("json", period_start, period_end, False)
    ...
    def test_export_analytics_data_with_user_details(self, service, mock_db, sample_billing_data):
        ...
        mock_db.query.side_effect = [mock_query] + [mock_user_query] * len(sample_billing_data)
        
        period_start = datetime.utcnow() - timedelta(days=30)
        period_end = datetime.utcnow()
        
        export_result = service.export_analytics_data("json", period_start, period_end, True)
