...
class TestEnhancedWebhookProcessing:
    ...
    def test_subscription_downgrade_after_max_failures(self, mock_db_session):
        ...
        mock_subscription.grace_period_ends_at = datetime.now() - timedelta(days=1)  # Expired
    ...
    def test_payment_retry_scheduling(self, mock_db_session):
        ...
        assert abs((mock_payment.next_retry_at - expected_delay).total_seconds()) < 60  # Within 1 minute
    ...
    def test_notification_system_integration(self, mock_db_session):
        ...
        with patch.object(service, 'logger') as mock_logger:
            service._send_payment_failure_notification(mock_subscription, mock_payment, 1)
    ...
    def test_webhook_health_monitoring(self, mock_db_session):
        ...
        from src.coaching_assistant.api.webhooks.ecpay import webhook_health_check
    ...
    def test_subscription_maintenance_task(self, mock_get_db):
        ...
        with patch('src.coaching_assistant.tasks.subscription_maintenance_tasks.ECPaySubscriptionService') as mock_service_class:
            ...
            with patch('src.coaching_assistant.tasks.subscription_maintenance_tasks._generate_maintenance_stats') as mock_stats:
    ...
    def test_failed_payment_retry_task(self, mock_db_session):
        ...
        with patch('src.coaching_assistant.tasks.subscription_maintenance_tasks._simulate_payment_retry', return_value=True):
            with patch('src.coaching_assistant.tasks.subscription_maintenance_tasks.get_db', return_value=[mock_db_session]):
    ...
    def test_webhook_log_cleanup_task(self, mock_db_session):
        ...
        from src.coaching_assistant.models import WebhookLog
    ...
    def test_manual_payment_retry_endpoint(self, mock_db_session):
        ...
        from src.coaching_assistant.api.webhooks.ecpay import handle_manual_payment_retry
        ...
        with patch('src.coaching_assistant.api.webhooks.ecpay.settings') as mock_settings:
            mock_settings.ADMIN_WEBHOOK_TOKEN = "admin123"
            
            # Mock ECPay service
            with patch('src.coaching_assistant.api.webhooks.ecpay.ECPaySubscriptionService') as mock_service_class:
                mock_service = Mock()
                mock_service.retry_failed_payments.return_value = True
                mock_service_class.return_value = mock_service
    ...
    def test_subscription_status_endpoint(self, mock_db_session):
        ...
        from src.coaching_assistant.api.webhooks.ecpay import get_subscription_webhook_status
