...
def create_assemblyai_segments():
    ...
    segments = [
        {
            "speaker": "A",
            "text": "你好 ， Lisha 你好 ， 我 是 你 今天 的 教練",
            "start": 0,
            "end": 3000,
        },
        {
            "speaker": "B",
            "text": "只是 想 說 這個 問題 其實 它 也 是 跟著 我 非常 非常 非常 久 的 問題 了",
            "start": 3000,
            "end": 8000,
        },
        ...
        {
            "speaker": "B",
            "text": "我 覺得 我 一直 以來 都 有 這種 拖延 的 習慣",
            "start": 10000,
            "end": 14000,
        },
        {
        ...
        {
            "speaker": "B",
            "text": "對啊 而且 我 發現 這個 問題 影響到 我 的 工作 和 生活",
            "start": 16000,
            "end": 20000,
        },
    ]
...
async def test_ab_format_parsing():
    ...
    for i, segment in enumerate(segments):
        ...
        print(
            f"  {i + 1}. {segment['speaker']}: {segment['text']} ({char_count} chars, {duration:.1f}s)"
        )
