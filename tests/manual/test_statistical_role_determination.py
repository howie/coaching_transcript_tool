...
from src.coaching_assistant.services.lemur_transcript_smoother import LeMURTranscriptSmoother, SmoothingContext, TranscriptSegment
...
def create_test_segments():
    ...
    test_segments = [
        TranscriptSegment(start=0, end=2000, speaker="Speaker_1", text="你好，今天想聊什麼？"),  # Coach - short
        TranscriptSegment(start=2000, end=8000, speaker="Speaker_2", text="我最近工作上遇到很多困難，感覺壓力很大，不知道該怎麼處理這些問題。每天都覺得很焦慮。"),  # Client - long
        TranscriptSegment(start=8000, end=10000, speaker="Speaker_1", text="可以具體說說是什麼樣的困難嗎？"),  # Coach - short
        TranscriptSegment(start=10000, end=18000, speaker="Speaker_2", text="主要是我的主管總是給我很多額外的工作，而且時間都很急，我常常需要加班到很晚。而且同事之間的關係也不太好，大家都很有競爭性。"),  # Client - long
        TranscriptSegment(start=18000, end=20000, speaker="Speaker_1", text="聽起來確實很有挑戰性。"),  # Coach - short
        TranscriptSegment(start=20000, end=28000, speaker="Speaker_2", text="對啊，我覺得自己好像無法平衡工作和生活。我的家人也開始抱怨我回家都很晚，週末也要工作。我真的不知道該怎麼辦。"),  # Client - long
        TranscriptSegment(start=28000, end=31000, speaker="Speaker_1", text="你希望達到什麼樣的平衡？"),  # Coach - short
    ]
...
def create_balanced_test_segments():
    ...
    balanced_segments = [
        TranscriptSegment(start=0, end=3000, speaker="Speaker_1", text="我想今天我們來討論一下你的職業發展。"),
        TranscriptSegment(start=3000, end=6000, speaker="Speaker_2", text="好的，我最近確實在考慮這個問題。"),
        TranscriptSegment(start=6000, end=9000, speaker="Speaker_1", text="你覺得目前的工作有什麼挑戰？"),
        TranscriptSegment(start=9000, end=12000, speaker="Speaker_2", text="主要是感覺成長空間有限制。"),
    ]
...
def test_statistical_determination():
    ...
    print(f"  Ratio (Speaker_2/Speaker_1): {total_chars_speaker2/max(total_chars_speaker1,1):.2f}")
...
客戶: 主要是工作量太大，而且同事關係複雜。"""
    ...
    original_segments = [
        ...
        {"speaker": "Speaker_2", "text": "我最近工作壓力很大", "start": 2000, "end": 5000},
        {"speaker": "Speaker_1", "text": "可以具體說說嗎", "start": 5000, "end": 7000},
        {"speaker": "Speaker_2", "text": "主要是工作量太大", "start": 7000, "end": 10000},
    ]
    ...
    try:
        ...
        if role_mapping:
            final_segments = smoother._apply_role_mapping_to_segments(parsed_segments, role_mapping)
