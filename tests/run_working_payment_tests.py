...
def run_working_tests():
    ...
    working_test_patterns = [
        ...
        "tests/regression/test_payment_error_scenarios.py::TestECPayCheckMacValueRegression::test_checkmacvalue_calculation_with_special_characters",
        "tests/regression/test_payment_error_scenarios.py::TestECPayCheckMacValueRegression::test_checkmacvalue_step7_dotnet_encoding_regression",
        "tests/regression/test_payment_error_scenarios.py::TestECPayCheckMacValueRegression::test_merchant_trade_no_length_regression",
        "tests/regression/test_payment_error_scenarios.py::TestPaymentAmountRegression::test_currency_conversion_precision_regression",
        "tests/regression/test_payment_error_scenarios.py::TestPaymentAmountRegression::test_annual_discount_calculation_regression",
