...
def run_unit_tests():
    ...
    cmd = [
        ...
        "-v",
        "-k",
        "TestPasswordHashing or TestJWTTokens",
        "--tb=short",
    ]
...
def run_integration_tests():
    ...
    cmd = [
        ...
        "-v",
        "-k",
        "not (TestPasswordHashing or TestJWTTokens)",
        "--tb=short",
    ]
...
def check_environment():
    ...
    if not os.path.exists("tests/api/test_auth.py"):
        print(
            "❌ test_auth.py not found. Please run this script from packages/core-logic/"
        )
        return False
    ...
    if not os.path.exists("src/coaching_assistant"):
        print(
            "❌ Source code not found. Please run this script from packages/core-logic/"
        )
        return False
