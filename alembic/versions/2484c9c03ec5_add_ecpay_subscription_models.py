...
def upgrade() -> None:
    ...
    op.create_table('billing_analytics',
    ...
    sa.Column('total_revenue_usd', sa.DECIMAL(precision=12, scale=4), nullable=False),
    sa.Column('subscription_revenue_usd', sa.DECIMAL(precision=12, scale=4), nullable=False),
    sa.Column('usage_overage_usd', sa.DECIMAL(precision=12, scale=4), nullable=False),
    sa.Column('one_time_fees_usd', sa.DECIMAL(precision=12, scale=4), nullable=False),
    sa.Column('sessions_created', sa.Integer(), nullable=False),
    sa.Column('transcriptions_completed', sa.Integer(), nullable=False),
    sa.Column('total_minutes_processed', sa.DECIMAL(precision=10, scale=2), nullable=False),
    ...
    sa.Column('google_stt_cost_usd', sa.DECIMAL(precision=10, scale=4), nullable=False),
    sa.Column('assemblyai_cost_usd', sa.DECIMAL(precision=10, scale=4), nullable=False),
    sa.Column('total_provider_cost_usd', sa.DECIMAL(precision=10, scale=4), nullable=False),
    sa.Column('plan_utilization_percentage', sa.DECIMAL(precision=5, scale=2), nullable=False),
    sa.Column('days_active_in_period', sa.Integer(), nullable=False),
    sa.Column('avg_sessions_per_active_day', sa.DECIMAL(precision=8, scale=2), nullable=False),
    ...
    sa.Column('success_rate_percentage', sa.DECIMAL(precision=5, scale=2), nullable=False),
    ...
    sa.Column('predicted_next_month_usage', sa.DECIMAL(precision=10, scale=2), nullable=False),
    sa.Column('upgrade_probability', sa.DECIMAL(precision=3, scale=2), nullable=False),
    sa.Column('lifetime_value_estimate', sa.DECIMAL(precision=12, scale=4), nullable=False),
    ...
    sa.UniqueConstraint('user_id', 'period_type', 'period_start', name='uq_billing_analytics_period')
    )
    op.create_index('idx_billing_analytics_churn_risk', 'billing_analytics', ['churn_risk_score'], unique=False)
    op.create_index('idx_billing_analytics_plan', 'billing_analytics', ['plan_name'], unique=False)
    op.create_index('idx_billing_analytics_recorded', 'billing_analytics', ['recorded_at'], unique=False)
    op.create_index('idx_billing_analytics_revenue', 'billing_analytics', ['total_revenue_usd'], unique=False)
    op.create_index('idx_billing_analytics_segment', 'billing_analytics', ['user_segment'], unique=False)
    op.create_index('idx_billing_analytics_user_period', 'billing_analytics', ['user_id', 'period_start'], unique=False)
