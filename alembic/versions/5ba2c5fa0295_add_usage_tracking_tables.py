...
def upgrade() -> None:
    ...
    sa.Column('exports_by_format', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_index('idx_usage_analytics_user', 'usage_analytics', ['user_id', 'month_year'])
    ...
    sa.Column('transcription_type', sa.Enum('ORIGINAL', 'RETRY_FAILED', 'RETRY_SUCCESS', 'EXPORT', 'MANUAL', name='transcriptiontype'), nullable=False),
    ...
    sa.Column('audio_file_size_mb', sa.DECIMAL(precision=8, scale=2), nullable=True),
    ...
    sa.ForeignKeyConstraint(['parent_log_id'], ['usage_logs.id'], ),
    ...
    op.add_column('user', sa.Column('session_count', sa.Integer(), nullable=False, server_default='0'))
    op.alter_column('user', 'session_count', server_default=None)
    op.add_column('user', sa.Column('transcription_count', sa.Integer(), nullable=False, server_default='0'))
    op.alter_column('user', 'transcription_count', server_default=None)
    op.add_column('user', sa.Column('current_month_start', sa.DateTime(timezone=True), nullable=True))
    op.add_column('user', sa.Column('total_sessions_created', sa.Integer(), nullable=False, server_default='0'))
    op.alter_column('user', 'total_sessions_created', server_default=None)
    op.add_column('user', sa.Column('total_transcriptions_generated', sa.Integer(), nullable=False, server_default='0'))
    op.alter_column('user', 'total_transcriptions_generated', server_default=None)
    op.add_column('user', sa.Column('total_minutes_processed', sa.DECIMAL(precision=10, scale=2), nullable=False, server_default='0'))
    op.alter_column('user', 'total_minutes_processed', server_default=None)
    op.add_column('user', sa.Column('total_cost_usd', sa.DECIMAL(precision=12, scale=4), nullable=False, server_default='0'))
