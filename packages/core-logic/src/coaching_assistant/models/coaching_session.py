...
from sqlalchemy import Column, String, Integer, ForeignKey, Text, Date, CheckConstraint
...
class CoachingSession(BaseModel):
    ...
    transcript_timeseq_id = Column(UUID(as_uuid=True), nullable=True)
    audio_timeseq_id = Column(UUID(as_uuid=True), nullable=True)
    ...
    def __repr__(self):
        return f"<CoachingSession(date={self.session_date}, client_id={self.client_id}, duration={self.duration_min}min)>"
