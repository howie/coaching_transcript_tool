...
class TestSpeakerAnalyzer:
    ...
    def test_word_counting_chinese(self):
        ...
        assert analyzer._count_words("你好嗎？") == 3  # 3 Chinese characters, punctuation ignored
        assert analyzer._count_words("Hello 你好") == 2  # Only Chinese characters counted
    ...
    def test_coaching_question_detection_english(self):
        ...
        assert analyzer._is_coaching_question("Help me understand your perspective.") is True
...
class TestSpeakerAnalysis:
    ...
    def test_analyze_two_speakers_coach_client(self):
        ...
        segments = [
            ...
            TranscriptSegment(1, 3.5, 9.5, "I've been struggling with work-life balance lately.", 0.8),
            TranscriptSegment(1, 13.5, 24.5, "Well, I've been working long hours and I feel like I'm missing out on family time. It's really stressing me out.", 0.8),
            TranscriptSegment(1, 28.5, 39.5, "It makes me feel guilty and frustrated. I want to be there for my family but I also need to perform at work.", 0.8),
        ]
    ...
    def test_role_assignment_clear_case(self):
        ...
        segments = [
            ...
            TranscriptSegment(1, 2.5, 7.5, "I'm struggling with anxiety and stress.", 0.8),
            TranscriptSegment(1, 10.5, 19.5, "Work has been overwhelming and I can't seem to manage my time effectively.", 0.8),
            TranscriptSegment(1, 22.5, 34.5, "It feels like I'm drowning in responsibilities and I don't know how to prioritize.", 0.8),
        ]
    ...
    def test_confidence_metrics_high_confidence(self):
        ...
        segments = [
            ...
            TranscriptSegment(1, 2.5, 7.5, "I'm struggling with work and feeling overwhelmed.", 0.8),
            TranscriptSegment(1, 10.5, 19.5, "The deadlines are impossible and my boss is unreasonable.", 0.8),
        ]
    ...
    def test_confidence_metrics_low_confidence(self):
        ...
        segments = [
            ...
            TranscriptSegment(0, 0.0, 5.0, "How was your weekend? I had a great time.", 0.9),
            TranscriptSegment(1, 5.5, 10.0, "Good, thanks. What did you do? I went hiking.", 0.9),
        ]
