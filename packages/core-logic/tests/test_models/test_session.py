...
class TestSessionProperties:
    ...
    def test_is_processing_complete_property(self, db_session, sample_user, status, expected):
...
class TestSessionRelationships:
    ...
    def test_session_cascade_delete(self, db_session, sample_session):
        ...
        deleted_segment = db_session.query(TranscriptSegment).filter_by(id=segment_id).first()
