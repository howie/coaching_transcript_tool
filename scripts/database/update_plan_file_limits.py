...
def update_plan_file_limits():
    ...
    with get_db_session() as db:
        ...
        for plan in plans:
            ...
            old_file_size = plan.limits.get("maxFileSize", plan.limits.get("max_file_size_mb", "not set"))
            ...
            print(f"✅ Updated {plan.plan_type.value} plan ({key_used}): {old_file_size} → 60 MB")
        ...
        print("\n📊 Verification:")
        for plan in plans:
            file_size = plan.limits.get("maxFileSize", plan.limits.get("max_file_size_mb", "not found"))
