...
def update_plan_pricing():
    ...
    with get_db_session() as db:
        ...
        for plan in plans:
            ...
            print(f"   Monthly: NT${old_monthly/100} → NT${plan.monthly_price_twd_cents/100}")
            print(f"   Annual: NT${old_annual/100} → NT${plan.annual_price_twd_cents/100}")
        ...
        print("\n📊 Verification:")
        for plan in plans:
            print(f"  {plan.plan_type.value}: Monthly NT${plan.monthly_price_twd_cents/100}, Annual NT${plan.annual_price_twd_cents/100}")
