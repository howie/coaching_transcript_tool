...
def reset_user_usage(email: str = None, user_id: str = None, reset_sessions: bool = True, reset_transcriptions: bool = True):
...
Examples:
  ...
  python reset_user_usage.py --user-id 12345678-1234-1234-1234-123456789012
    ...
    reset_group.add_argument("--sessions-only", action="store_true", help="Reset only session count")
    reset_group.add_argument("--transcriptions-only", action="store_true", help="Reset only transcription count")
