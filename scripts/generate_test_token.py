...
try:
    ...
    print("❌ jose library not found. Install with: pip install python-jose[cryptography]")
    sys.exit(1)
...
def main():
    ...
    parser.add_argument("--user-id", help="User ID for token (generates random UUID if not provided)")
