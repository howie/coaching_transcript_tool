...
def get_version_info():
    ...
    try:
        ...
        possible_paths = [
            Path(__file__).parent.parent.parent.parent.parent.parent / "version.json",  # From src/coaching_assistant
            Path(__file__).parent.parent.parent.parent / "version.json",  # From packages/core-logic
