...
```
┌─────────────────┐    ┌──────────────────┐    ┌─────────────────┐
│  Presentation   │    │    Gateway       │    │    Backend      │
│   (Frontend)    │<-->│  (Middleware)    │<-->│   (API/Data)    │
│                 │    │                  │    │                 │
│ • Next.js 14    │    │ • CF Workers     │    │ • FastAPI       │
│ • TypeScript    │    │ • Hono.js        │    │ • Python 3.11+  │
│ • Tailwind CSS  │    │ • Rate Limiting  │    │ • pandas        │
│ • NextAuth.js   │    │ • Caching        │    │ • SQLAlchemy    │
└─────────────────┘    └──────────────────┘    └─────────────────┘
```
